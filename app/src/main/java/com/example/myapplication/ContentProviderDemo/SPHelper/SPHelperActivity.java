package com.example.myapplication.ContentProviderDemo.SPHelper;
...
//跨进程sp
public class SPHelperActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sphelper);
...
//        Set<String> set = SPHelper.getStringSet("c",null);
        ...
        TextView value= (TextView) findViewById(R.id.sp_helper_values);
